...
def plot_min_ffd(close_prices: pd.Series, max_d = 2, pval_threshold: float = 0.05):
    ...
    plotting out adf stats as well as correlation graph, as well as minimum d value to use
    ...
    pval_threshold: p-value to pass ADF test
    """
    return FractionalDifferentiation.plot_min_ffd(close_prices, max_d, pval_threshold)
